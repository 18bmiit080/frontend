    ...
    <div class="row">
        <div class="col-md-3 border-right">
            ...
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><button class="btn btn-success" type="button ">Save Profile</button></div>
                    <div class="col-md-6"><button class="btn btn-success" type="button ">Reset Password</button></div>
                </div>
            </div>
        </div>
    </div> 
